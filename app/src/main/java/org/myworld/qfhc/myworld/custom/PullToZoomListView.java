...
public class PullToZoomListView extends ListView implements
    ...
    private void init(Context paramContext) {
        ...
        view = LayoutInflater.from(getContext()).inflate(R.layout.mine_head, null);
        // viewcourse = LayoutInflater.from(getContext()).inflate(R.layout.plan_xiangqing_toubu, null);
        ...
        ////设置默认图片
        this.mHeaderImage.setImageResource(R.drawable.bg_me);
//		this.mHeaderImage = new ImageView(paramContext);
...
//        this.mHeaderContainer.addView(viewcourse);
...
// 	return this.view;
// }
// public View getHeaderViewCourse() {
